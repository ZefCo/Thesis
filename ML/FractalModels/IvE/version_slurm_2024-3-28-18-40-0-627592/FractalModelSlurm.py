...
b = tf.keras.layers.Conv2D(3, (1, 1), padding = "same", activation="gelu")(a)
# b = tf.keras.layers.ReLU()(b)
b = tf.keras.layers.BatchNormalization()(b)
# b = tf.keras.layers.MaxPooling2D(pool_size = (2, 2))(b)

c = tf.keras.layers.Conv2D(3, (1, 1), padding = "same", activation="gelu")(b)
# c = tf.keras.layers.ReLU()(c)
c = tf.keras.layers.BatchNormalization()(c)

bc = tf.keras.layers.add([b, c])
bc = tf.keras.layers.MaxPooling2D(pool_size = (2, 2))(bc)

d = tf.keras.layers.Conv2D(5, (1, 1), padding = "same", activation = "gelu")(bc)
d = tf.keras.layers.BatchNormalization()(d)
# d = tf.keras.layers.MaxPooling2D(pool_size = (2, 2))(d)

e = tf.keras.layers.Conv2D(5, (1, 1), padding = "same", activation = "gelu")(d)
