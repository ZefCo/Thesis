...
# Input layer, 64x64x1 -> 32x32x4
a = tf.keras.layers.Conv2D(5, (3, 3), padding = "same", activation="gelu")(input_layer) #), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(input_layer)
a = tf.keras.layers.MaxPooling2D(pool_size = (2, 2))(a)
a = tf.keras.layers.BatchNormalization()(a)

# First convolutional layer, 32x32x4 -> 16x16x16
b = tf.keras.layers.Conv2D(25, (3, 3), padding = "same", activation="gelu")(a)
b = tf.keras.layers.MaxPooling2D(pool_size = (2, 2))(b)
b = tf.keras.layers.BatchNormalization()(b)

# Second convolution layer, 16x16x16 -> 8x8x64 
c = tf.keras.layers.Conv2D(125, (3, 3), padding = "same", activation="gelu")(b)
c = tf.keras.layers.MaxPooling2D(pool_size = (2, 2))(c)
c = tf.keras.layers.BatchNormalization()(c)

# Third convolutional layer, 8x8x9 -> 4x4x12
# d = tf.keras.layers.Conv2D(81, (3, 3), padding = "same", activation = "gelu")(c)
# d = tf.keras.layers.MaxPooling2D(pool_size = (2, 2))(d)
# d = tf.keras.layers.BatchNormalization()(d)

# e = tf.keras.layers.Conv2D(5, (2, 2), padding = "same", activation = "gelu")(d)
...
dense = tf.keras.layers.Dense(50, activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(flatten)
