...
a = tf.keras.layers.Conv2D(w, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(input_layer)
a = tf.keras.layers.Dropout(.5)(a)
a = tf.keras.layers.BatchNormalization()(a)
b = tf.keras.layers.Conv2D(w / 2, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(a)
b = tf.keras.layers.Dropout(.5)(b)
b = tf.keras.layers.BatchNormalization()(b)
c = tf.keras.layers.Conv2D(w / 2, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(b)
c = tf.keras.layers.Dropout(.5)(c)
c = tf.keras.layers.BatchNormalization()(c)
d = tf.keras.layers.Conv2D(w / 2, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(c)
d = tf.keras.layers.Dropout(.5)(d)
d = tf.keras.layers.BatchNormalization()(d)
e = tf.keras.layers.Conv2D(w / 2, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(d)
e = tf.keras.layers.Dropout(.5)(e)
e = tf.keras.layers.BatchNormalization()(e)
f = tf.keras.layers.Conv2D(w / 4, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(e)
f = tf.keras.layers.Dropout(.5)(f)
f = tf.keras.layers.BatchNormalization()(f)
g = tf.keras.layers.Conv2D(w / 4, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(f)
g = tf.keras.layers.Dropout(.5)(g)
g = tf.keras.layers.BatchNormalization()(g)
h = tf.keras.layers.Conv2D(w / 4, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(g)
h = tf.keras.layers.Dropout(.5)(h)
h = tf.keras.layers.BatchNormalization()(h)
i = tf.keras.layers.Conv2D(w / 4, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(h)
i = tf.keras.layers.Dropout(.5)(i)
i = tf.keras.layers.BatchNormalization()(i)
j = tf.keras.layers.Conv2D(w / 8, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(i)
j = tf.keras.layers.Dropout(.5)(j)
j = tf.keras.layers.BatchNormalization()(j)
flatten = tf.keras.layers.Flatten()(j)
