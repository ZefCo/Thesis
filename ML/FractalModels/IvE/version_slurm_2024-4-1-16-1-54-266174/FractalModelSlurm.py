...
a = tf.keras.layers.Conv2D(4, (3, 3), padding = "same", activation="gelu")(input_layer) #), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(input_layer)
a = tf.keras.layers.MaxPooling2D(pool_size = (2, 2))(a)
a = tf.keras.layers.BatchNormalization()(a)

# First convolutional layer, 32x32x4 -> 16x16x16
b = tf.keras.layers.Conv2D(16, (3, 3), padding = "same", activation="gelu")(a)
b = tf.keras.layers.MaxPooling2D(pool_size = (2, 2))(b)
b = tf.keras.layers.BatchNormalization()(b)

# Second convolution layer, 16x16x16 -> 8x8x64 
c = tf.keras.layers.Conv2D(64, (3, 3), padding = "same", activation="gelu")(b)
