...
b = tf.keras.layers.Conv2D(5, (1, 1), padding = "same", activation="gelu")(a)
# b = tf.keras.layers.ReLU()(b)
b = tf.keras.layers.BatchNormalization()(b)
b = tf.keras.layers.MaxPooling2D(pool_size = (2, 2))(b)
c = tf.keras.layers.Conv2D(5, (1, 1), strides = (2, 2), padding = "same", activation="gelu")(b)
# c = tf.keras.layers.ReLU()(c)
c = tf.keras.layers.BatchNormalization()(c)
bc = tf.keras.layers.add([b, c])
d = tf.keras.layers.Conv2D(9, (3, 3), padding = "same", activation = "gelu")(bc)
