...
b = tf.keras.layers.Conv2D(3, (2, 2), padding = "same", activation="gelu")(a)
# b = tf.keras.layers.ReLU()(b)
b = tf.keras.layers.BatchNormalization()(b)
# b = tf.keras.layers.MaxPooling2D(pool_size = (2, 2))(b)

c = tf.keras.layers.Conv2D(3, (2, 2), padding = "same", activation="gelu")(b)
...
d = tf.keras.layers.Conv2D(5, (2, 2), padding = "same", activation = "gelu")(bc)
