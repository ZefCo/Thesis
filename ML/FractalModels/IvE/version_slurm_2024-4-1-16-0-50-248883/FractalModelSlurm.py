...
a = tf.keras.layers.Conv2D(4, (3, 3), padding = "same", activation="relu")(input_layer) #), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(input_layer)
...
c = tf.keras.layers.Conv2D(64, (3, 3), padding = "same", activation="relu")(b)
