...
c = tf.keras.layers.Conv2D(w, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(b)
c = tf.keras.layers.Dropout(.5)(c)
c = tf.keras.layers.BatchNormalization()(c)
d = tf.keras.layers.Conv2D(w, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(c)
