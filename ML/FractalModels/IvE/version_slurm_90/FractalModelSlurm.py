...
b = tf.keras.layers.Conv2D(w, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(a)
...
e = tf.keras.layers.Conv2D(w, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(d)
e = tf.keras.layers.Dropout(.5)(e)
e = tf.keras.layers.BatchNormalization()(e)
f = tf.keras.layers.Conv2D(w, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(e)
f = tf.keras.layers.Dropout(.5)(f)
f = tf.keras.layers.BatchNormalization()(f)
g = tf.keras.layers.Conv2D(w, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(f)
g = tf.keras.layers.Dropout(.5)(g)
g = tf.keras.layers.BatchNormalization()(g)
h = tf.keras.layers.Conv2D(w, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(g)
h = tf.keras.layers.Dropout(.5)(h)
h = tf.keras.layers.BatchNormalization()(h)
i = tf.keras.layers.Conv2D(w, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(h)
i = tf.keras.layers.Dropout(.5)(i)
i = tf.keras.layers.BatchNormalization()(i)
j = tf.keras.layers.Conv2D(w, (2, 2), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.001))(i)
