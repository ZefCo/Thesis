...
a = tf.keras.layers.Conv2D(w, (1, 1), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.0001))(input_layer)
a = tf.keras.layers.Dropout(.5)(a)
a = tf.keras.layers.BatchNormalization()(a)
b = tf.keras.layers.Conv2D(h, (6, 6), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.0001))(a)
b = tf.keras.layers.Dropout(.5)(b)
b = tf.keras.layers.BatchNormalization()(b)
c = tf.keras.layers.Conv2D(64, (12, 12), activation = "gelu", kernel_regularizer = tf.keras.regularizers.l2(l = 0.0001))(b)
