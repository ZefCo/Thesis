...
def main(data_filepath, label_filepath, onehot_filepath,
    ...
    # x = tf.keras.layers.Dropout(.25)(x)
    x = tf.keras.layers.Conv1D(filters = 20, kernel_size = 3, activation="tanh")(x)
    # x = tf.keras.layers.Dropout(.4)(x)
    x = tf.keras.layers.Conv1D(filters = 50, kernel_size = 3, activation="tanh")(x)
    # x = tf.keras.layers.Dropout(.4)(x)
    x = tf.keras.layers.Conv1D(filters = 200, kernel_size = 3, activation="tanh")(x)
    x = tf.keras.layers.Conv1D(filters = 500, kernel_size = 3, activation="tanh")(x)
